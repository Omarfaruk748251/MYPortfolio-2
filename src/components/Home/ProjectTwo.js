    ...
    return (
        <>
            ...
            <div className="text-center">
                <a style={{ marginRight: "10px", fontWeight: "bold" }} target="_blank" href="https://clever-hermann-fc308e.netlify.app/">Live-Site</a>
                <a style={{ marginRight: "10px", fontWeight: "bold" }} target="_blank" href="https://github.com/Omarfaruk748251/Travel-and-Tourism-Client-Side">Frontend-code</a>
                <a style={{ marginRight: "10px", fontWeight: "bold" }} target="_blank" href="https://github.com/Omarfaruk748251/Travel-and-Tourism-Server-Side">Backend-code</a>
            </div>
        </>
    );
};
